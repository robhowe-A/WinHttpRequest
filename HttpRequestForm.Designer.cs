...
namespace ArticleJsonFetch
{
    partial class HTTPRequest
    {
        ...
        private void InitializeComponent()
        {
            ...
            toolStripMenuItemDisableDnsTest = new ToolStripMenuItem();
            ...
            contentTypeComboBox.Items.AddRange(new object[] { "", "application/json" });
            contentTypeComboBox.Location = new Point(287, 30);
            ...
            label4.Location = new Point(202, 33);
            ...
            methodCombo.Items.AddRange(new object[] { "GET", "HEAD", "OPTIONS", "POST", "PUT" });
            ...
            // btnJSON
            // 
            btnJSON.Location = new Point(1, 57);
            btnJSON.Margin = new Padding(1);
            btnJSON.Name = "btnJSON";
            btnJSON.Size = new Size(49, 38);
            btnJSON.TabIndex = 1001;
            btnJSON.Text = "JSON";
            btnJSON.UseVisualStyleBackColor = true;
            btnJSON.Click += btnToJSON_Click;
            // 
            // richTxtData
            // 
            ...
            toolStripSplitOptions.DropDownItems.AddRange(new ToolStripItem[] { toolStripMenuItemShowContentHeaders, toolStripMenuItemDisableDnsTest });
            ...
            // 
            // toolStripMenuItemDisableDnsTest
            // 
            toolStripMenuItemDisableDnsTest.CheckOnClick = true;
            toolStripMenuItemDisableDnsTest.Name = "toolStripMenuItemDisableDnsTest";
            toolStripMenuItemDisableDnsTest.Size = new Size(195, 22);
            toolStripMenuItemDisableDnsTest.Text = "Disable Dns Test";
            // 
            // toolStripSeparator2
            // 
            ...
            panel1.Controls.Add(contentTypeComboBox);
        ...
        private ToolStripMenuItem toolStripMenuItemDisableDnsTest;
